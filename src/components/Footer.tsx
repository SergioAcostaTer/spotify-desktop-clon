export const Footer = () => {
  return (
    <footer className="flex w-full mt-[68px] px-[10px] flex-col gap-y-[24px]">
      <div className="flex justify-between w-full pb-[24px] border-b-[1px] border-[#ffffff20]">
        <div className="flex gap-[96px]">
          <ul className="flex flex-col gap-y-[8px]">
            <li className="text-[#fff] text-[16px] mb-[8px] font-bold">
              Company
            </li>
            <li className="text-[#a7a7a7] text-[16px] mb-[8px] hover:text-[#fff] transition-all duration-100 hover:underline cursor-pointer hover:text-[#fff] transition-all duration-100 hover:underline cursor-pointer">
              About
            </li>
            <li className="text-[#a7a7a7] text-[16px] mb-[8px] hover:text-[#fff] transition-all duration-100 hover:underline cursor-pointer">
              Jobs
            </li>
            <li className="text-[#a7a7a7] text-[16px] mb-[8px] hover:text-[#fff] transition-all duration-100 hover:underline cursor-pointer">
              For the Record
        ...
        <div className="mt-[16px]">
          <div className="flex gap-x-[16px]">
            <a
              ...
              className="flex justify-center items-center w-[40px] h-[40px] rounded-full bg-[#ffffff20] hover:bg-[#ffffff50] transition-all duration-300"
            >
              <svg
                role="img"
                height="16"
            ...
            <a
              href="https://www.twitter.com/spotify/"
              target="_blank"
              rel="noopener noreferrer"
              className="flex justify-center items-center w-[40px] h-[40px] rounded-full bg-[#ffffff20] hover:bg-[#ffffff50] transition-all duration-300"
            >
      ...
      <div className="flex justify-between w-full pt-[10px] pb-[70px]">
        <div className="flex gap-x-[20px]">
          <p className="text-[#a7a7a7] text-[16px] hover:text-[#fff] transition-all duration-100 hover:underline cursor-pointer">
            Legal
          </p>
          <p className="text-[#a7a7a7] text-[16px] hover:text-[#fff] transition-all duration-100 hover:underline cursor-pointer">
            Privacy Center
