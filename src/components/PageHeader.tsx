...
export default function PageHeader({
  ...
  return (
    <div
      className={`absolute top-0 left-0 w-full z-10 px-[20px] relative h-[64px] flex items-center justify-between rounded-t-[8px]`}
      style={{ backgroundColor: `${backgroundColor}${opacityHex}` }}
    >
        ...
        <div className="flex justify-between">
          <div className="flex items-center gap-[8px] h-[32px]">
            ...
            {title && (
              ...
              >
                <button>
                  <span className="rounded-full bg-[#1ED760] flex items-center justify-center w-[48px] h-[48px]">
                    <svg
                      role="img"
                      height="24"
                      width="24"
                ...
                <span className="text-[1.5rem] text-white font-bold truncate">
                  {title}
                </span>
              </div>
            )}
